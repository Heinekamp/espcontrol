> [!NOTE]  
> This is a fork of the [original EspControl project](https://github.com/jtenniswood/espcontrol) that adds support for the Waveshare ESP32-S3 3.5-inch touchscreen panel. 

> [!Caution]
> This is a proof-of-concept fork that was mostly generated by Claude and has not been fully tested. It is not guaranteed to work and may require additional configuration or troubleshooting. Use at your own risk.
